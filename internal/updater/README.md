...
repo must be in "owner/repo" format, e.g. "lucasassuncao/apptide". currentVersion is the running binary's version \(e.g. "1.2.3" or "v1.2.3"\); the update is skipped when it matches the latest release tag.
